...
/**
 * Tour transaction entry interface
 * Represents a single transaction entry for a tour
 */
interface TourTransactionEntry {
    ...
    /** Tour code associated with the transaction */
    tour_code: string;
    ...
    coa_code: string;
    /** Type of account (income, expense, asset, liability) */
    account_type: string;
    /** Debit amount */
    debit: number;
    /** Credit amount */
...
/**
 * Props for the TourTransactionsModal component
 * Displays a modal with tour transaction details
 */
interface TourTransactionsModalProps {
    ...
    onClose: () => void;
    /** Tour code to filter transactions */
    tourCode: string;
}
